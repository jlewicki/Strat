...
module StateTree =
   ...
   val fromRoot: id: StateId -> handler: StateHandler<'D,'M> -> initialTransition: InitialTransition<'D> -> childStates: seq<CreateChildState<'D,'M>> -> StateTree<'D,'M>
   ...
   val interior: id: StateId -> handler: StateHandler<'D,'M> -> initialTransition: InitialTransition<'D> -> childStates: seq<CreateChildState<'D,'M>> -> CreateChildState<'D,'M>